 ...
 * @author miholeus
 */
class NewClassic_Models_Object_CategoryMapperTest extends ControllerTestCase
{
    /**
     *
     * @var NewClassic_Models_Object_Category
     */
    protected $_object;
    /**
     *
     * @var NewClassic_Models_Object_CategoryMapper
     */
     ...
     * @var string
     */
    protected $_objectClass = 'NewClassic_Models_Object_Category';
    /**
     * Name of object's collection class
     *
     * @var string
     */
    protected $_objectCollectionClass = 'NewClassic_Models_Object_CategoryCollection';
    /**
     * Name ob object mapper class
     *
     * @var string
     */
    protected $_objectMapperClass = 'NewClassic_Models_Object_CategoryMapper';
