...
/**
 * Description of VoteMapperTest
 *
 * @author miholeus
 */
class NewClassic_Models_Object_VoteMapperTest extends ControllerTestCase
{
    /**
     *
     * @var NewClassic_Models_Object_Vote
     */
    protected $_object;
    /**
     *
     * @var NewClassic_Models_Object_VoteMapper
     */
     ...
     * @var string
     */
    protected $_objectClass = 'NewClassic_Models_Object_Vote';
    /**
     * Name of object's collection class
     *
     * @var string
     */
    protected $_objectCollectionClass = 'NewClassic_Models_Object_VoteCollection';
    /**
     * Name ob object mapper class
     *
     * @var string
     */
    protected $_objectMapperClass = 'NewClassic_Models_Object_VoteMapper';
