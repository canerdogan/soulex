 ...
 * @author miholeus
 */
class NewClassic_Models_FamousAuthor_ModelTest extends ControllerTestCase
{
    protected $data;
    protected $model;
    ...
    protected function setUp()
    {
        ...
        $this->data = array(
            ...
            'firstname' => 'Leonardo',
            'lastname' => 'Da Vinchi',
            'dayOfBirth' => '1452-04-15',
            'dayOfDeath' => '1519-05-02',
            'country' => 'Italy',
            'specialty' => 'Architector'
        );
        $this->model = new NewClassic_Models_FamousAuthor_Model();
    }
    /**
