 ...
 * @author miholeus
 */
class NewClassic_Models_Specialization_ModelMapperTest extends ControllerTestCase
{
    /**
     *
     * @var NewClassic_Models_Specialization_Model
     */
    protected $_object;
    /**
     *
     * @var NewClassic_Models_Specialization_ModelMapper
     */
     ...
     * @var string
     */
    protected $_objectClass = 'NewClassic_Models_Specialization_Model';
    /**
     * Name of object's collection class
     *
     * @var string
     */
    protected $_objectCollectionClass = 'NewClassic_Models_Specialization_ModelCollection';
    /**
     * Name ob object mapper class
     *
     * @var string
     */
    protected $_objectMapperClass = 'NewClassic_Models_Specialization_ModelMapper';
