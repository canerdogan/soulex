...
/**
 * Description of CommentsMapperTest
 *
 * @author miholeus
 */
class NewClassic_Models_Goods_CommentsMapperTest extends ControllerTestCase
{
    /**
     *
     * @var NewClassic_Models_Goods_Comments
     */
    protected $_object;
    /**
     *
     * @var NewClassic_Models_Goods_CommentsMapper
     */
     ...
     * @var string
     */
    protected $_objectClass = 'NewClassic_Models_Goods_Comments';
    /**
     * Name of object's collection class
     *
     * @var string
     */
    protected $_objectCollectionClass = 'NewClassic_Models_Goods_CommentsCollection';
    /**
     * Name ob object mapper class
     *
     * @var string
     */
    protected $_objectMapperClass = 'NewClassic_Models_Goods_CommentsMapper';
