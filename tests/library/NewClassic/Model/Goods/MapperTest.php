 ...
 * @author miholeus
 */
class NewClassic_Model_Goods_MapperTest extends ControllerTestCase
{
    /**
     *
     * @var NewClassic_Model_Goods_Goods
     */
    protected $_object;
    /**
     *
     * @var NewClassic_Model_Goods_Mapper
     */
     ...
     * @var string
     */
    protected $_objectClass = 'NewClassic_Model_Goods_Goods';
    /**
     * Name of object's collection class
     *
     * @var string
     */
    protected $_objectCollectionClass = 'NewClassic_Model_Goods_Collection';
    /**
     * Name ob object mapper class
     *
     * @var string
     */
    protected $_objectMapperClass = 'NewClassic_Model_Goods_Mapper';

    protected function prepareData()
    {
        $fixture = FixtureLoader::getInstance();
        $data = $fixture->load('NewClassic/Goods');
