 ...
 * @author miholeus
 */
class NewClassic_Model_Material_MapperTest extends ControllerTestCase
{
    /**
     *
     * @var NewClassic_Model_Material_Material
     */
    protected $_object;
    /**
     *
     * @var NewClassic_Model_Material_Mapper
     */
     ...
     * @var string
     */
    protected $_objectClass = 'NewClassic_Model_Material_Material';
    /**
     * Name of object's collection class
     *
     * @var string
     */
    protected $_objectCollectionClass = 'NewClassic_Model_Material_Collection';
    /**
     * Name ob object mapper class
     *
     * @var string
     */
    protected $_objectMapperClass = 'NewClassic_Model_Material_Mapper';

    protected function prepareData()
    {
        $fixture = FixtureLoader::getInstance();
        $data = $fixture->load('NewClassic/Material');
