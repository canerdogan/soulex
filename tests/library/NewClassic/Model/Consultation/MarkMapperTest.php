...
/**
 * Description of MarkMapperTest
 *
 * @author miholeus
 */
class NewClassic_Models_Consultation_MarkMapperTest extends ControllerTestCase
{
    /**
     *
     * @var NewClassic_Models_Consultation_Mark
     */
    protected $_object;
    /**
     *
     * @var NewClassic_Models_Consultation_MarkMapper
     */
     ...
     * @var string
     */
    protected $_objectClass = 'NewClassic_Models_Consultation_Mark';
    /**
     * Name of object's collection class
     *
     * @var string
     */
    protected $_objectCollectionClass = 'NewClassic_Models_Consultation_MarkCollection';
    /**
     * Name ob object mapper class
     *
     * @var string
     */
    protected $_objectMapperClass = 'NewClassic_Models_Consultation_MarkMapper';
