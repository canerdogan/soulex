...
/**
 * Description of StatusMapperTest
 *
 * @author miholeus
 */
class NewClassic_Models_User_StatusMapperTest extends ControllerTestCase
{
    /**
     *
     * @var NewClassic_Model_User_Status
     */
    protected $_object;
    /**
     *
     * @var NewClassic_Model_User_StatusMapper
     */
     ...
     * @var string
     */
    protected $_objectClass = 'NewClassic_Model_User_Status';
    /**
     * Name of object's collection class
     *
     * @var string
     */
    protected $_objectCollectionClass = 'NewClassic_Model_User_StatusCollection';
    /**
     * Name ob object mapper class
     *
     * @var string
     */
    protected $_objectMapperClass = 'NewClassic_Model_User_StatusMapper';

    protected function prepareData()
    {
        $fixture = FixtureLoader::getInstance();
        $data = $fixture->load('NewClassic/UserStatus');
