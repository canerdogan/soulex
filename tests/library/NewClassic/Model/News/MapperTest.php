 ...
 * @author miholeus
 */
class NewClassic_Model_News_MapperTest extends ControllerTestCase
{
    /**
     *
     * @var NewClassic_Models_News_News
     */
    protected $_object;
    /**
     *
     * @var NewClassic_Model_News_Mapper
     */
     ...
     * @var string
     */
    protected $_objectClass = 'NewClassic_Model_News_News';
    /**
     * Name of object's collection class
     *
     * @var string
     */
    protected $_objectCollectionClass = 'NewClassic_Model_News_Collection';
    /**
     * Name ob object mapper class
     *
     * @var string
     */
    protected $_objectMapperClass = 'NewClassic_Model_News_Mapper';
