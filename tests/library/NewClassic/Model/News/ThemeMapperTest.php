...
/**
 * Description of ThemeMapperTest
 *
 * @author miholeus
 */
class NewClassic_Model_News_ThemeMapperTest extends ControllerTestCase
{
    /**
     *
     * @var NewClassic_Model_News_Theme
     */
    protected $_object;
    /**
     *
     * @var NewClassic_Model_News_ThemeMapper
     */
     ...
     * @var string
     */
    protected $_objectClass = 'NewClassic_Model_News_Theme';
    /**
     * Name of object's collection class
     *
     * @var string
     */
    protected $_objectCollectionClass = 'NewClassic_Model_News_ThemeCollection';
    /**
     * Name ob object mapper class
     *
     * @var string
     */
    protected $_objectMapperClass = 'NewClassic_Model_News_ThemeMapper';

    protected function prepareData()
    {
        $fixture = FixtureLoader::getInstance();
        $data = $fixture->load('NewClassic/NewsTheme');
