 ...
 * @author miholeus
 */
class NewClassic_Model_Service_CategoryMapperTest extends ControllerTestCase
{
    /**
     *
     * @var NewClassic_Model_Service_Category
     */
    protected $_object;
    /**
     *
     * @var NewClassic_Model_Service_CategoryMapper
     */
     ...
     * @var string
     */
    protected $_objectClass = 'NewClassic_Model_Service_Category';
    /**
     * Name of object's collection class
     *
     * @var string
     */
    protected $_objectCollectionClass = 'NewClassic_Model_Service_CategoryCollection';
    /**
     * Name ob object mapper class
     *
     * @var string
     */
    protected $_objectMapperClass = 'NewClassic_Model_Service_CategoryMapper';

    protected function prepareData()
    {
        $fixture = FixtureLoader::getInstance();
        $data = $fixture->load('NewClassic/ServiceCategory');
