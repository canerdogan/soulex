 ...
 * @author miholeus
 */
class NewClassic_Model_Supplier_MapperTest extends ControllerTestCase
{
    /**
     *
     * @var NewClassic_Model_Supplier_Supplier
     */
    protected $_object;
    /**
     *
     * @var NewClassic_Model_Supplier_Mapper
     */
     ...
     * @var string
     */
    protected $_objectClass = 'NewClassic_Model_Supplier_Supplier';
    /**
     * Name of object's collection class
     *
     * @var string
     */
    protected $_objectCollectionClass = 'NewClassic_Model_Supplier_Collection';
    /**
     * Name ob object mapper class
     *
     * @var string
     */
    protected $_objectMapperClass = 'NewClassic_Model_Supplier_Mapper';

    protected function prepareData()
    {
        $fixture = FixtureLoader::getInstance();
        $data = $fixture->load('NewClassic/Supplier');
        $this->_object->setOptions($data);
        // should load countries, user_statuses and user_groups as
        // there is foreign key constraints
    }
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals($name, $updatedobject->getUsername());
    }
