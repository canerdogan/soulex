 ...
 * @author miholeus
 */
class NewClassic_Models_Event_ModelTest extends ControllerTestCase
{
    protected $data;
    protected $model;
    ...
    protected function setUp()
    {
        ...
        $this->data = array(
            'id' => 1,
            'evtype' => 'some event type',
            'date' => '2011-01-01 00:00:00',
            'place' => 'City Hall',
            'startTime' => '00:00:00',
            'info' => 'New Year Coming',
            'anonce' => 'Happy New Year!',
            'descr' => 'What great moments you will see in next year!',
            'source' => 'http://google.com',
            'userCreated' => 1,
            'userActivated' => 1,
            'publishDate' => '2010-12-28 15:42:34'
        );
        $this->model = new NewClassic_Models_Event_Model();
    }
    /**
