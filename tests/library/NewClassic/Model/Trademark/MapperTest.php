 ...
 * @author miholeus
 */
class NewClassic_Models_Trademark_MapperTest extends ControllerTestCase
{
    /**
     *
     * @var NewClassic_Models_Trademark_Model
     */
    protected $_object;
    /**
     *
     * @var NewClassic_Model_Trademark_Mapper
     */
     ...
     * @var string
     */
    protected $_objectClass = 'NewClassic_Model_Trademark_Trademark';
    /**
     * Name of object's collection class
     *
     * @var string
     */
    protected $_objectCollectionClass = 'NewClassic_Model_Trademark_Collection';
    /**
     * Name ob object mapper class
     *
     * @var string
     */
    protected $_objectMapperClass = 'NewClassic_Model_Trademark_Mapper';

    protected function prepareData()
    {
        $fixture = FixtureLoader::getInstance();
        $data = $fixture->load('NewClassic/Trademark');
