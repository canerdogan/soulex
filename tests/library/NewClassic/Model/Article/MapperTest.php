 ...
 * @author miholeus
 */
class NewClassic_Models_Article_ModelMapperTest extends ControllerTestCase
{
    /**
     *
     * @var NewClassic_Model_Article_Article
     */
    protected $_object;
    /**
     *
     * @var NewClassic_Model_Article_Mapper
     */
     ...
     * @var string
     */
    protected $_objectClass = 'NewClassic_Model_Article_Article';
    /**
     * Name of object's collection class
     *
     * @var string
     */
    protected $_objectCollectionClass = 'NewClassic_Model_Article_Collection';
    /**
     * Name ob object mapper class
     *
     * @var string
     */
    protected $_objectMapperClass = 'NewClassic_Model_Article_Mapper';

    protected function prepareData()
    {
        $fixture = FixtureLoader::getInstance();
        $data = $fixture->load('NewClassic/Article');
