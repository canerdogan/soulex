...
/**
 * Description of TypeMapperTest
 *
 * @author miholeus
 */
class NewClassic_Models_Library_TypeMapperTest extends ControllerTestCase
{
    /**
     *
     * @var NewClassic_Models_Library_Type
     */
    protected $_object;
    /**
     *
     * @var NewClassic_Models_Library_TypeMapper
     */
     ...
     * @var string
     */
    protected $_objectClass = 'NewClassic_Models_Library_Type';
    /**
     * Name of object's collection class
     *
     * @var string
     */
    protected $_objectCollectionClass = 'NewClassic_Models_Library_TypeCollection';
    /**
     * Name ob object mapper class
     *
     * @var string
     */
    protected $_objectMapperClass = 'NewClassic_Models_Library_TypeMapper';
