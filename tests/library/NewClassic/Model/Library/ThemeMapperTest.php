 ...
 * @author miholeus
 */
class NewClassic_Models_Library_ModelMapperTest extends ControllerTestCase
{
    /**
     *
     * @var NewClassic_Models_Library_Model
     */
    protected $_object;
    /**
     *
     * @var NewClassic_Models_Library_ThemeMapper
     */
     ...
     * @var string
     */
    protected $_objectClass = 'NewClassic_Models_Library_Theme';
    /**
     * Name of object's collection class
     *
     * @var string
     */
    protected $_objectCollectionClass = 'NewClassic_Models_Library_ThemeCollection';
    /**
     * Name ob object mapper class
     *
     * @var string
     */
    protected $_objectMapperClass = 'NewClassic_Models_Library_ThemeMapper';
