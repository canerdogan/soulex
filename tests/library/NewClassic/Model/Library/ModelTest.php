...
class NewClassic_Models_Library_ModelTest extends ControllerTestCase
{
    protected $data;
    protected $model;
    ...
    protected function setUp()
    {
        ...
        $this->data = array(
            ...
            'detailPhoto' => 'detail.png',
            'rarity' => 1,
            'attachment' => 'attachment.pdf',
            'annotation' => 'test note',
            'buyLink' => 'http://miholeus.com'
        );
        $this->model = new NewClassic_Models_Library_Model();
    }
    /**
