...
class NewClassic_Models_Library_ModelMapperTest extends ControllerTestCase
{
    ...
    /**
     *
     * @var NewClassic_Models_Library_ModelMapper
     */
     ...
     * @var string
     */
    protected $_objectClass = 'NewClassic_Models_Library_Model';
    /**
     * Name of object's collection class
     *
     * @var string
     */
    protected $_objectCollectionClass = 'NewClassic_Models_Library_ModelCollection';
    /**
     * Name ob object mapper class
     *
     * @var string
     */
    protected $_objectMapperClass = 'NewClassic_Models_Library_ModelMapper';
