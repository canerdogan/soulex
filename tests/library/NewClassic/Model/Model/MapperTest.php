 ...
 * @author miholeus
 */
class NewClassic_Model_Model_MapperTest extends ControllerTestCase
{
    /**
     *
     * @var NewClassic_Model_Model_Model
     */
    protected $_object;
    /**
     *
     * @var NewClassic_Model_Model_Mapper
     */
     ...
     * @var string
     */
    protected $_objectClass = 'NewClassic_Model_Model_Model';
    /**
     * Name of object's collection class
     *
     * @var string
     */
    protected $_objectCollectionClass = 'NewClassic_Model_Model_Collection';
    /**
     * Name ob object mapper class
     *
     * @var string
     */
    protected $_objectMapperClass = 'NewClassic_Model_Model_Mapper';

    protected function prepareData()
    {
        $fixture = FixtureLoader::getInstance();
        $data = $fixture->load('NewClassic/Model');
