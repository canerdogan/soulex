 ...
 * @author miholeus
 */
class NewClassic_Model_Projects3d_MapperTest extends ControllerTestCase
{
    /**
     *
     * @var NewClassic_Models_Projects3d_Projects3d
     */
    protected $_object;
    /**
     *
     * @var NewClassic_Models_Projects3d_Mapper
     */
     ...
     * @var string
     */
    protected $_objectClass = 'NewClassic_Model_Projects3d_Projects3d';
    /**
     * Name of object's collection class
     *
     * @var string
     */
    protected $_objectCollectionClass = 'NewClassic_Model_Projects3d_Collection';
    /**
     * Name ob object mapper class
     *
     * @var string
     */
    protected $_objectMapperClass = 'NewClassic_Model_Projects3d_Mapper';

    protected function prepareData()
    {
        $fixture = FixtureLoader::getInstance();
        $data = $fixture->load('NewClassic/Projects3d');
    ...
    {
        $name = 'foo';
        $this->_object->setDocumentation($name);
        ...
        $this->assertEquals($name, $updatedobject->getDocumentation());
    }
