 ...
 * @author miholeus
 */
class Admin_Model_NewsMapperTest extends ControllerTestCase
{
    /**
     *
    ...
    {
        parent::setUp();
        $this->_object = new Admin_Model_News();
        ...
        $objectMapper = new Admin_Model_NewsMapper();
    ...
    public function testFetchAll()
    {
        ...
        $this->assertType('Admin_Model_NewsCollection', $objects);
    }
    ...
    public function testDelete()
    {
        ...
        try {
            ...
            $mapper->findById(1);
            $this->fail('News with id 1 was not deleted');
        } catch (UnexpectedValueException $e) {
            // SUCCESS
            $this->assertTrue(true);
        }
    ...
    protected function tearDown()
    {
        parent::tearDown();
        $objectMapper = new Admin_Model_NewsMapper();
        $objectMapper->getDbTable()->getDefaultAdapter()->query('TRUNCATE TABLE news');
    }
}
