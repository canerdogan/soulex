...
/**
 * Description of InsjobController
 *
 * @author miholeus
 */
class Admin_InsjobcatController extends Soulex_Controller_Abstract
{
    protected $model;
    protected $form;
    protected $mapper;
    ...
    {
        $this->mapper = new Admin_Model_InsjobCategoryMapper();
        $this->model = new Admin_Model_InsjobCategory();
    ...
    public function indexAction()
    {
            ...
            try {
                if (is_array($post['cid'])) {
                    ...
                    try {
                        ...
                        return $this->_redirect('/admin/insjobcat');
                    } catch (Exception $e) {
                ...
                $this->renderError("Job category deletion failed with the following error: "
                        . $e->getMessage());
            }
        } else {
        ...
        $this->view->render('insjobcat/index.phtml');
    }
    ...
    public function createAction()
    {
        if($this->_request->isPost()
            ...
            try {
                ...
                $this->renderError("Job category creation failed with the following error: "
                        . $e->getMessage());
            }
        }
        ...
        $this->renderSubmenu(false);
        $this->view->render('insjobcat/create.phtml');
    }
    public function editAction()
    {
        ...
        if($this->_request->isPost()
            ...
            try {
                ...
                $this->renderSubmenu(false);
                $this->renderError("Job category update failed with the following error: "
                        . $e->getMessage());
            }
        }
        ...
        $this->view->render('insjobcat/edit.phtml');
    }
    /**
    ...
    public function deleteAction()
    {
		...
		$this->_redirect('/admin/insjobcat');
    }
    ...
    private function _getOrderParams()
    {
         ...
         */
        if(!is_callable(array(new Admin_Model_InsjobCategory(),
            'get' . ucfirst($order)))) {
            $order = 'name';
        }
