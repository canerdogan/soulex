 ...
 * @author miholeus
 */
class Admin_InsadvicecatController extends Soulex_Controller_Abstract
{
    public function preDispatch()
    {
        $this->mapper = new Admin_Model_InsadviceCategoryMapper();
        $this->model = new Admin_Model_InsadviceCategory();
    ...
    public function indexAction()
    {
            ...
            try {
                if (is_array($post['cid'])) {
                    ...
                    try {
                        ...
                        return $this->_redirect('/admin/insadvicecat');
                    } catch (Exception $e) {
        ...
        $this->view->render('insadvicecat/index.phtml');
    }
    ...
    public function createAction()
    {
        if($this->_request->isPost()
            ...
            try {
                ...
                $this->renderError("Insadvice category creation failed with the following error: "
                        . $e->getMessage());
            }
        }
        ...
        $this->renderSubmenu(false);
        $this->view->render('insadvicecat/create.phtml');
    }
    public function editAction()
    {
        ...
        $this->view->render('insadvicecat/edit.phtml');
    }
    /**
    ...
    public function deleteAction()
    {
		...
		$this->_redirect('/admin/insadvicecat');
    }
    ...
    private function _getOrderParams()
    {
         ...
         */
        if(!is_callable(array(new Admin_Model_InsadviceCategory(),
            'get' . ucfirst($order)))) {
            $order = 'name';
        }
