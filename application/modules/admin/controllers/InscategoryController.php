...
/**
 * Description of InscategoryController
 *
 * @author miholeus
 */
class Admin_InscategoryController extends Soulex_Controller_Abstract
{
    protected $model;
    protected $form;
    protected $mapper;
    ...
    {
        $this->mapper = new Admin_Model_InsCategoryMapper();
        $this->model = new Admin_Model_InsCategory();
    ...
    public function indexAction()
    {
        ...
        $this->view->render('inscategory/index.phtml');
    }
    ...
    public function createAction()
    {
        ...
        $this->renderSubmenu(false);
        $this->view->render('inscategory/create.phtml');
    }
    public function editAction()
    {
        ...
        $this->view->render('inscategory/edit.phtml');
    }
    /**
    ...
    public function deleteAction()
    {
		...
		$this->_redirect('/admin/inscategory');
    }
    ...
    private function _getOrderParams()
    {
         ...
         */
        if(!is_callable(array(new Admin_Model_InsCategory(),
            'get' . ucfirst($order)))) {
            $order = 'name';
        }
