...
/**
 * Description of InsblogcatController
 *
 * @author miholeus
 */
class Admin_InsblogcatController extends Soulex_Controller_Abstract
{
    protected $model;
    protected $form;
    protected $mapper;
    ...
    {
        $this->mapper = new Admin_Model_InsblogCategoryMapper();
        $this->model = new Admin_Model_InsblogCategory();
    ...
    public function indexAction()
    {
            ...
            try {
                if (is_array($post['cid'])) {
                    ...
                    try {
                        ...
                        return $this->_redirect('/admin/insblogcat');
                    } catch (Exception $e) {
                ...
                $this->renderError("Advice category deletion failed with the following error: "
                        . $e->getMessage());
            }
        } else {
        ...
        $this->view->render('insblogcat/index.phtml');
    }
    ...
    public function createAction()
    {
        if($this->_request->isPost()
            ...
            try {
                ...
                $this->renderError("Blog category creation failed with the following error: "
                        . $e->getMessage());
            }
        }
        ...
        $this->renderSubmenu(false);
        $this->view->render('insblogcat/create.phtml');
    }
    public function editAction()
    {
        ...
        if($this->_request->isPost()
            ...
            try {
                ...
                $this->renderSubmenu(false);
                $this->renderError("Blog update failed with the following error: "
                        . $e->getMessage());
            }
        }
        ...
        $this->view->render('insblogcat/edit.phtml');
    }
    /**
    ...
    public function deleteAction()
    {
		...
		$this->_redirect('/admin/insblogcat');
    }
    ...
    private function _getOrderParams()
    {
         ...
         */
        if(!is_callable(array(new Admin_Model_InsblogCategory(),
            'get' . ucfirst($order)))) {
            $order = 'name';
        }
